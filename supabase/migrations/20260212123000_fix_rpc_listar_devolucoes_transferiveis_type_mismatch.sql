-- ============================================
-- HOTFIX: corrigir mismatch de tipos no retorno de listar_devolucoes_transferiveis
-- Erro observado: Returned type character varying(200) does not match expected type text (coluna 11)
-- ============================================
...
'Lista devoluções transferíveis com valor_restante derivado deterministicamente; hotfix de tipagem explícita de colunas de texto';
