-- ============================================
-- FASE 2.2: Atualizar RPC de transferência para persistir rastreabilidade de destino
-- ============================================
-- Atualiza transferir_devolucoes_estoque(payload JSONB) para gravar:
-- - movimentacoes_estoque.operacao_destino_id (quando destino = estoque)
-- - movimentacoes_estoque.lancamento_destino_id (quando destino = conta)
-- ============================================
...
'RPC transacional: transferência de devoluções com idempotência (request_id) e rastreabilidade determinística de destino (operacao_destino_id/lancamento_destino_id)';
